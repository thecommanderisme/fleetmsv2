...
import com.prog.fleetmsv2.parameters.services.ClientService;
...
public class ClientController {
	...
	@RequestMapping(value="/parameters/client/delete", method = {RequestMethod.DELETE, RequestMethod.GET})
